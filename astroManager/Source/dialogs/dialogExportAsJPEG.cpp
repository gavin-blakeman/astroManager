...
namespace AstroManager
{
  namespace dialogs
  {
    ...
    {
      settings::astroManagerSettings->setValue(settings::DIALOG_EXPORTASJPEG_QUALITY, QVariant(spinBoxImageQuality->value()));
    ...
    void CDialogExportAsJPEG::setupUI()
    {
      ...
      spinBoxImageQuality->setValue(settings::astroManagerSettings->value(settings::DIALOG_EXPORTASJPEG_QUALITY, QVariant(80)).toInt());
