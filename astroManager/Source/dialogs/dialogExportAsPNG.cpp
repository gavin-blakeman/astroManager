...
namespace AstroManager
{
  namespace dialogs
  {
    ...
    {
      settings::VSOPSettings->setValue(settings::DIALOG_EXPORTASPNG_QUALITY, QVariant(spinBoxImageQuality->value()));
    ...
    void CDialogExportAsPNG::setupUI()
    {
      ...
      spinBoxImageQuality->setValue(settings::VSOPSettings->value(settings::DIALOG_EXPORTASPNG_QUALITY, QVariant(80)).toInt());
