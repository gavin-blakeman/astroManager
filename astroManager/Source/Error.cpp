...
namespace AstroManager
{
  ...
  void loadErrorMessages()
  {
    std::vector<std::pair<GCL::TErrorCode, std::string>> errors =
    {
      ...
      {0x0700, std::string("SIMBAD: Invalid Region type.")},
      ...
      {0x4000, std::string("DATABASE: ARID: Error in function isImageFilenameRegistered.")},
      {0x4001, std::string("DATABASE: ARID: Error in function saveOriginalImage.")},
      {0x4002, std::string("DATABASE: ARID: Error while opening file prior to storing in database.")},
      {0x4003, std::string("")},
