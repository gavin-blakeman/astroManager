...
namespace astroManager
{
  namespace mdiframe
  {
    ...
    {
      calibration::CCreateMasterBiasWindow *imageWindow = new calibration::CCreateMasterBiasWindow(this);
      mdiArea->addSubWindow(imageWindow);
    ...
    {
      calibration::CCreateMasterDarkWindow *imageWindow = new calibration::CCreateMasterDarkWindow(this);
      mdiArea->addSubWindow(imageWindow);
    ...
    {
      calibration::CCreateMasterFlatWindow *imageWindow = new calibration::CCreateMasterFlatWindow(this);
      mdiArea->addSubWindow(imageWindow);
